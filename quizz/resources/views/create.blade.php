...
<h3>Create New Question</h3>
    ...
    <form method="POST" action="/create-question-action/<?php echo $cats[0]->id; ?>">
        ...
        <div><label >Answer 1:</label>
          <input type="text" name="answera" placeholder="Answer 1" required></div>

        <div><label >Answer 2:</label>
          <input type="text" name="answerb" placeholder="Answer 2" required></div>
        </div>

        <div class="col-md-6">
        <div><label >Answer 3:</label>
          <input type="text" name="answerc" placeholder="Answer 3" required></div>

        <div><label >Answer 4:</label>
          <input type="text" name="answerd" placeholder="Answer 4" required></div>
        </div>
        </div>
